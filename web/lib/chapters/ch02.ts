...
for t in tools:
  ...
  aiExchange: {
    userMessage: "Build a file reader tool and bind it to the model.",
    aiLabel: "GENERATING TOOL",
    aiDescription: "Implementing read_file with @tool decorator. Auto-generating JSON schema from type hints...",
    aiCodeSnippet: `@tool
def read_file(filepath: str) -> str:
